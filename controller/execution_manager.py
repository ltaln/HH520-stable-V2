...
PROMPT_FILE = "HH520_Stable_V3_4_Prediction_Prompt.md"
...
def execute_prediction(date: str, use_gpt: bool = False):
    ...
    # Normal GitHub Actions mode does not call OpenAI again. Instead it emits a
    # V3.4 handoff package so the connected ChatGPT can explain/review the
    # already locked deterministic prediction without changing it.
    if not use_gpt:
        root = Path(__file__).resolve().parents[1]
        data["gpt_handoff"] = {
            "role": "EXPLANATION_ONLY",
            "stable_version": "HH520 Stable V3.4",
            "prompt_version": "HH520_Stable_V3_4_Prediction_Prompt.md",
